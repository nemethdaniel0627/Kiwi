    ...
    return (
        <footer>
            ...
            <div className="footer--social Amatic">
                <a href="#" className="footer--social--links footer--social--twitter">
                ...
                <a href="instagram.com" className="footer--social--links footer--social--insta">
                ...
                <a href="#" className="footer--social--links footer--social--email">
                    Support
                ...
                <a href="#" className="footer--social--links footer--social--phone">
                    Phone
