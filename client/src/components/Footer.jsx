    ...
    return (
        <footer>
            ...
            <div className="footer--social Amatic">
                <a target="_blank" href={props.twitterHref} className="footer--social--links footer--social--twitter">
                ...
                <a target="_blank" href={props.instaHref} className="footer--social--links footer--social--insta">
                ...
                <a onClick={showPopupEmail} className="footer--social--links footer--social--email">
                    {props.email}
                ...
                <a onClick={showPopupLinked} className="footer--social--links footer--social--phone">
                    {props.linkedIn}
